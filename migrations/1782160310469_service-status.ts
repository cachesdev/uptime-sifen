...
export async function up(pgm: MigrationBuilder): Promise<void> {
  pgm.createTable('service_status', {
    ...
    servicio: {
      ...
      notNull: true,
      check:
        "servicio IN ('Envío DE Sincrónico', 'Envío Lote Asincrónico', 'Consulta CDC', 'Consulta Lote', 'Consulta RUC', 'Eventos')"
    },
  ...
  pgm.createIndex('service_status', ['servicio', 'entorno', 'sampled_at'], {
    name: 'service_status_servicio_entorno_time_idx'
  });
...
export async function down(pgm: MigrationBuilder): Promise<void> {
  ...
  pgm.dropIndex('service_status', ['servicio', 'entorno', 'sampled_at'], {
    name: 'service_status_servicio_entorno_time_idx'
  });
